                ...
                <div class="row g-4">
                    <div class="col-sm-12">
                        <div class="bg-light rounded p-4">
                            <h3 class="mb-4 text-center text-primary">Cập nhật thông tin cá nhân</h3>
                            ...
                            <?php } ?>
                            <form action="<?=BASE_URL?>hoso/themhoso" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="floatingInput" name="ns">
                                ...
                                <div class="form-floating mb-3 ">
                                    <select class="form-select" id="huyen" name="huyen" required>
                                        <option value="" selected>Chọn...</option>
                                    </select>
                                    <label for="floatingSelect">Quận/huyện</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" name="xathcs" required>
                                    <label for="floatingInput">Xã/Phường</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" name="thcs" required>
